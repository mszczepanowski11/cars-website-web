...
const STATIC_CATEGORIES: CategoryWithCount[] = [
    ...
    { id: 13, slug: 'quady-atv', name: 'Quady i ATV', description: 'Quady sportowe, użytkowe i pojazdy SSV/UTV', iconName: 'mdi-quadbike', advertCount: 0 },
    { id: 14, slug: 'skutery-wodne', name: 'Skutery wodne', description: 'Skutery wodne jedno- i wieloosobowe', iconName: 'mdi-jet-ski', advertCount: 0 },
