...
const plans = computed<Plan[]>(() => [
    {
        ...
        singlePrice: '2,99 zł', singlePriceNum: 2.99, durations: null,
    ...
    },
    {
        ...
        durations: [
            { days: 7, price: '9,99 zł', priceNum: 9.99 },
            { days: 14, price: '14,99 zł', priceNum: 14.99 },
            { days: 30, price: '24,99 zł', priceNum: 24.99 },
        ],
    ...
    },
    {
        ...
        singlePrice: null, singlePriceNum: 0,
        durations: [
            { days: 7, price: '24,99 zł', priceNum: 24.99 },
            { days: 14, price: '39,99 zł', priceNum: 39.99 },
            { days: 30, price: '59,99 zł', priceNum: 59.99 },
        ],
