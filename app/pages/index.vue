...
<a href="https://www.ing.pl/male-firmy/leasing" target="_blank" rel="noopener noreferrer" class="ing-cta">Sprawdź ofertę <v-icon icon="mdi-arrow-right" size="13" /></a>
                        </div>
                        <div class="ing-card">
                            <div class="ing-card-icon">
...
<a href="https://www.ing.pl/indywidualni/kredyty-i-pozyczki" target="_blank" rel="noopener noreferrer" class="ing-cta">Oblicz ratę <v-icon icon="mdi-arrow-right" size="13" /></a>
                        </div>
                        <div class="ing-card">
                            <div class="ing-card-icon">
                            ...
                            <a href="https://www.ing.pl/male-firmy/kredyty-i-pozyczki" target="_blank" rel="noopener noreferrer" class="ing-cta">Skontaktuj się <v-icon icon="mdi-arrow-right" size="13" /></a>
                        </div>
...
<a href="https://www.ing.pl/indywidualni/kredyty-i-pozyczki" target="_blank" rel="noopener noreferrer" class="ing-cta">Złóż wniosek <v-icon icon="mdi-arrow-right" size="13" /></a>
                        </div>
                    </div>
...
const SEARCH_CATEGORIES = [
    ...
    { slug: 'quady-atv',       label: 'Quady i ATV',     icon: 'mdi-atv' },
    { slug: 'skutery-wodne',   label: 'Skutery wodne',   icon: 'mdi-ski-water' },
...
const SEARCH_CONFIGS: Record<string, SearchConfig> = {
    ...
    'przyczepy':    { hasBrand: false, hasModel: false, hasFuel: false, hasBodyType: false, hasMileage: false, hasHours: false, subtypeLabel: 'Typ', subtypes: ['Plandeka', 'Laweta', 'Wywrotka', 'Kempingowa', 'Kontenerowa'] },
