...
import {
    type ExtraField, type CatFieldConfig,
    FINISH_SWATCHES, CATEGORY_CONFIGS, DEFAULT_CAT_CONFIG,
    SUBTYPE_EXTRA_FIELDS, EF_LOCK_MAP,
} from '~/utils/advertFormConfig'
...
.add-page {
    ...
    // ginal licznik krokow. Pozostale strony serwisu robia to tak samo (padding-top: $page-top).
