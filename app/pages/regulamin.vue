        ...
        <div class="container page-body">
            <div class="doc-content">
                ...
                <section class="doc-section">
                    <h2>SŁOWNIK POJĘĆ</h2>
                    <ol>
                        <li><strong>Administrator</strong> – Wiktor Niezgoda prowadzący jednoosobową działalność gospodarczą pod firmą CARIZO Wiktor Niezgoda z siedzibą w Krakowie, pod adresem ul. Henryka Pachońskiego 7/60, 31-223 Kraków, wpisaną do Centralnej Ewidencji i Informacji o Działalności Gospodarczej (CEIDG) prowadzonej przez Ministra właściwego do spraw finansów i gospodarki, pod numerem NIP: 9452331007, REGON: 544870688.</li>
                        ...
                        <li><strong>Przedsiębiorca na prawach Konsumenta</strong> – Użytkownik będący osobą fizyczną, zawierający z Administratorem umowę bezpośrednio związaną z prowadzoną przez niego działalnością gospodarczą, gdy z treści tej umowy wynika, że nie posiada ona dla niego charakteru zawodowego, wynikającego w szczególności z przedmiotu wykonywanej przez niego działalności gospodarczej, udostępnionego na podstawie przepisów o Centralnej Ewidencji i Informacji o Działalności Gospodarczej (CEIDG).</li>
                ...
                <section class="doc-section">
                    ...
                    <ol>
                        ...
                        <li>Standardowy czas publikacji Ogłoszenia wynosi 35 dni.</li>
                        <li>Po upływie 35 dni Ogłoszenie wygasa automatycznie i zostaje przeniesione do archiwum Konta Użytkownika. Użytkownik ma możliwość ponownej, ręcznej aktywacji Ogłoszenia z poziomu swojego Konta.</li>
                ...
                <section class="doc-section">
                    ...
                    <ol>
                        <li>Podczas dodawania Ogłoszenia dotyczącego pojazdu Serwis zaleca podanie prawidłowego, autentycznego i kompletnego 17-znakowego numeru VIN (Vehicle Identification Number) — Ogłoszenia z podanym numerem VIN oznaczane są w Serwisie jako zweryfikowane i uwzględniane w mechanizmie plasowania ofert opisanym w §5. Podanie numeru VIN nie jest obowiązkowe, jednak jeżeli Użytkownik zdecyduje się go podać, ma obowiązek podania numeru prawidłowego, autentycznego i dotyczącego rzeczywiście oferowanego pojazdu — podanie nieprawidłowego, fałszywego lub cudzego numeru VIN stanowi naruszenie Regulaminu (§9). Podanie numeru rejestracyjnego pojazdu jest opcjonalne.</li>
                ...
                <section class="doc-section">
                    ...
                    <ol>
                        <li>Kupującemu będącemu konsumentem oraz Przedsiębiorcy na prawach Konsumenta przysługuje prawo do pisemnego odstąpienia od zawartej umowy o świadczenie usług drogą elektroniczną (w tym umowy o prowadzenie Konta oraz umów o usługi promowania) bez podania przyczyny, w terminie 14 (słownie: czternastu) dni od daty zawarcia umowy, na podstawie ustawy z dnia 30 maja 2014 r. o prawach konsumenta (Dz.U. z 2014 r. poz. 827 ze zm.), poprzez złożenie jednoznacznego oświadczenia woli na adres e-mail: <strong>kontakt@carizo.eu</strong>.</li>
                        <li>Uprawnienie, o którym mowa w punkcie powyżej, przysługuje również osobie fizycznej – Przedsiębiorcy na prawach Konsumenta, zawierającej z Administratorem umowę bezpośrednio związaną z jej działalnością gospodarczą, gdy z treści tej umowy wynika, że nie posiada ona dla tej osoby charakteru zawodowego, wynikającego w szczególności z przedmiotu wykonywanej przez nią działalności gospodarczej, udostępnionego na podstawie przepisów o Centralnej Ewidencji i Informacji o Działalności Gospodarczej.</li>
                        ...
                        <li><strong>Koszty zwrotu przy odstąpieniu:</strong> Usługi świadczone przez CARIZO mają charakter wyłącznie cyfrowy (usługi teleinformatyczne) i nie obejmują dostawy żadnych towarów fizycznych. W związku z tym odstąpienie od umowy przez Kupującego, w tym Przedsiębiorcę na prawach Konsumenta, nie wiąże się z obowiązkiem zwrotu towaru ani z ponoszeniem kosztów przesyłki. Wszelkie koszty dostawy fizycznych towarów (np. pojazdów lub części) będących przedmiotem transakcji pomiędzy Użytkownikami Serwisu obciążają strony tej transakcji i są przez nie ustalane bezpośrednio.</li>
                        <li><strong>Gwarancja producenta:</strong> CARIZO nie jest producentem ani sprzedawcą pojazdów mechanicznych ani części motoryzacyjnych. CARIZO świadczy wyłącznie usługi cyfrowe (publikacja ogłoszeń, usługi promowania). Gwarancji producenta na pojazdy lub części będące przedmiotem ogłoszeń udzielają odpowiednio ich producenci lub importerzy — Użytkownik (sprzedający) zobowiązany jest do przekazania kupującemu wszelkich dokumentów gwarancyjnych posiadanych do sprzedawanego pojazdu lub części. Odpłatne usługi CARIZO (pakiety promowania, emisja ogłoszeń) nie podlegają gwarancji producenta w rozumieniu art. 577 Kodeksu cywilnego.</li>
                        <li>Użytkownikowi, w tym Przedsiębiorcy na prawach Konsumenta, przysługuje prawo do złożenia reklamacji w przypadku niewykonania lub nienależytego wykonania usług o charakterze teleinformatycznym przez CARIZO (np. błędy techniczne w wyświetlaniu płatnego promowania, nieprawidłowe działanie Konta).</li>
                        ...
                        <li>CARIZO rozpatruje reklamacje Użytkowników, w tym Przedsiębiorców na prawach Konsumenta, w nieprzekraczalnym, ustawowym terminie 14 dni od dnia ich prawidłowego otrzymania. Odpowiedź wysyłana jest na adres e-mail przypisany do Konta Użytkownika.</li>
                    </ol>
                </section>
                ...
                <section class="doc-section">
                    ...
                    <ol>
                        ...
                        <li>Treść niniejszych postanowień wchodzi w życie z dniem 04.07.2026. Ostatnia aktualizacja: 04.07.2026.</li>
                    </ol>
                </section>
