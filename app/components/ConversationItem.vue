    ...
    >
        ...
        <div class="conv-avatar-wrap">
            <div class="conv-avatar">
                <img v-if="conv.otherUserAvatar" :src="conv.otherUserAvatar" :alt="conv.otherUserName" class="avatar-img" loading="lazy" decoding="async" />
        ...
        <div class="conv-body">
            ...
            <div class="conv-advert">
                <img v-if="conv.advertThumbnail" :src="conv.advertThumbnail" class="advert-thumb" :alt="conv.advertTitle" loading="lazy" decoding="async" />
